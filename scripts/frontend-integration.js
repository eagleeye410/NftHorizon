 ...
 * This file demonstrates how to integrate Nfthorizon with a web frontend
 */

// For React/Vue/Angular applications
export class NfthorizonClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NfthorizonClient(provider, contractAddress);
